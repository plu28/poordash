...
- Colter Purcell: Implemented Customer Orders page, Customer Order History page, Review Order component, and overall Customer Order workflow, set up localstorage api integration for persisting data, and initialized base shadcn library components.
